...
class Net(nn.Module):
    ...
    def forward(self, enc_graph, dec_graph, ufeat, ifeat, uhfeat, ihfeat, Two_Stage = False):
        ...
        return pred_ratings, reg_loss, closs, rcloss
...
def evaluate(args, net, dataset, segment='valid', debug = False, idx = 0):
    ...
    net.eval()
    with th.no_grad():
        pred_ratings, reg_loss, _, _ = net(enc_graph, dec_graph,
...
def train(args):
    ...
    for iter_idx in range(1, args.train_max_iter):
        ...
        if iter_idx > 250:
            ...
            Two_Stage = False
        Two_Stage = False
        pred_ratings, reg_loss, closs, rcloss = net(dataset.train_enc_graph, dataset.train_dec_graph,
        ...
        if args.loss_func == "CE":
            ...
            C = CE + 0.1 * CE_left + 0.1 * CE_right + rcloss * alpha + closs * beta
            #C = CE + rcloss * alpha + closs * beta
            loss = C + args.ARR * reg_loss 
            print(loss, closs*0.01, rcloss*0.01, args.ARR * reg_loss)
